...
module ShellCheck.Interface
    ...
    , Shell(Ksh, Sh, Bash, Dash, BusyboxSh, IrixBsh, IrixSh, IrixKsh, IrixDtksh)
...
data Shell = Ksh | Sh | Bash | Dash | BusyboxSh | IrixBsh | IrixSh | IrixKsh | IrixDtksh deriving (Show, Eq)
